...
namespace Unity.Animation
{
    ...
    public struct AnimationCurveBlob
    {
        ...
        public Builder CreateBuilder(ref BlobBuilder builder, AnimationCurveType type, int keyframeLength)
        {
            return new Builder(ref this, ref builder, type, keyframeLength);
        }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal Builder(ref AnimationCurveBlob curve, ref BlobBuilder builder, AnimationCurveType type, int keyframeCount)
            {
